...
-- ----------------------------
INSERT INTO `tbl_products` VALUES (1, '1', '2', 'APPLE MACBOOK', 'MAC_ICU_33', '28000', 'THIS IS APPLE MACBOOK PRO', '1701340351.jpg', '2023-11-29 15:29:17', '2023-11-30 10:32:31');
...
-- ----------------------------
INSERT INTO `tbl_users` VALUES (1, 'Aasif', 'asif@asif.com', '$2y$10$ZHA/e/6wuauZI9pqPt/ok./Mvoj30iXl90sroO3XnZ7GQAkH6f.Pi', '1', '1701245516.jpeg', NULL, '2023-11-30 11:11:29');
INSERT INTO `tbl_users` VALUES (7, 'Muhammad Asif', 'masif@khaleejtimes.com', '567575', '1', '1701244897.jpg', '2023-11-29 08:01:37', '2023-11-29 10:25:09');
...
CREATE TABLE `tbl_users_favorites`  (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `unique`(`user_id` ASC, `product_id` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci ROW_FORMAT = Dynamic;
