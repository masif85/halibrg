jQuery(document).ready(function(){
 		...
 		jQuery('.country').each(function(){
			...
			var url = 'https://widgets.media.devops.arabiaweather.com/widget/khaleej?locationID='+code;
                  ...
                  jQuery("#weather-container").html('').animate({opacity: 0}, function(){ }).end();
            
        		jQuery("#weather-container").html('<iframe id="wifrm" onload="" src="'+ url +'" scrolling="no"></iframe>').animate({opacity: 1}, 500,function(){   }).end();
